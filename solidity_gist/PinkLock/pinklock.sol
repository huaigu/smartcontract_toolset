...
// https://www.certik.com/projects/pinksale
...
contract PinkLock is IPinkLock, OwnableUpgradeable, UUPSUpgradeable {
  ...
  Lock[] private _locks; // 锁定列表
  mapping(address => EnumerableSetUpgradeable.UintSet) private _userLpLockIds; // 地址=> LP锁定列表 address => lockId[]
  mapping(address => EnumerableSetUpgradeable.UintSet)
    private _userNormalLockIds; // 地址=> 普通Token锁定列表, address => lockId[]

  EnumerableSetUpgradeable.AddressSet private _lpLockedTokens; // lp address 持有人列表
  EnumerableSetUpgradeable.AddressSet private _normalLockedTokens; // normal token 持有人列表
